...
class LoadingViewController: UIViewController {
    ...
    private func animation() {
        UIView.animateKeyframes(withDuration: 2,
            ...
            if self.counter < 1 {
                ...
                let toViewController = WebViewController()
    ...
    private func pathAnimation() {
        ...
        NSLayoutConstraint.activate([
            ...
            cloudView.bottomAnchor.constraint(equalTo: centerDot.topAnchor, constant: -10),
        ...
        let pathAnimationEnd = CABasicAnimation(keyPath: "strikeEnd")
